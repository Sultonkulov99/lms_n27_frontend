          ...
          <div className="bg-white p-4 rounded-t-2xl border-b border-gray-100 flex flex-wrap gap-4 items-center justify-between shadow-sm">
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="flex items-center gap-1 text-sm">
                ...
                <button className="w-8 h-8 flex items-center justify-center rounded-lg hover:bg-gray-100 text-gray-600 font-medium transition-colors">2</button>
                <button className="w-8 h-8 flex items-center justify-center rounded-lg hover:bg-gray-100 text-gray-600 font-medium transition-colors">3</button>
                <span className="text-gray-400 mx-1">...</span>
                <button className="w-8 h-8 flex items-center justify-center rounded-lg hover:bg-gray-100 text-gray-600 font-medium transition-colors">15</button>
          ...
          <div className="bg-white rounded-b-2xl shadow-sm border border-gray-100 overflow-hidden">
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-gray-50/50 border-b border-gray-100">
                    ...
                    <th className="p-4 text-[13px] font-semibold text-gray-600">Ism</th>
                    <th className="p-4 text-[13px] font-semibold text-gray-600">Telefon raqami</th>
                    <th className="p-4 text-[13px] font-semibold text-gray-600">Narxi</th>
                    <th className="p-4 text-[13px] font-semibold text-gray-600">To'lov turi</th>
                    <th className="p-4 text-[13px] font-semibold text-gray-600">Yaratilgan vaqt</th>
                ...
                <tbody className="divide-y divide-gray-100">
                  ...
                  {/* Row 1 */}
                  <tr className={`hover:bg-blue-50/30 transition-colors ${selectedRows.includes(1) ? 'bg-blue-50/50' : ''}`}>
                    <td className="p-4">
                      <input 
                        type="checkbox" 
                    ...
                    <td className="p-4 text-gray-600 text-[13px]">+998 00 000 00 00</td>
                    <td className="p-4 text-gray-900 font-medium">250 000</td>
                    <td className="p-4 text-gray-600 text-[13px]">Payme</td>
                    <td className="p-4 text-gray-500 text-[13px]">01.01.2024</td>
                    <td className="p-4">
                  ...
                  {/* Row 2 */}
                  <tr className={`hover:bg-blue-50/30 transition-colors ${selectedRows.includes(2) ? 'bg-blue-50/50' : ''}`}>
                    <td className="p-4">
                      <input 
                        type="checkbox" 
            ...
            <div className="bg-gray-50/50 px-6 py-4 border-t border-gray-100 flex items-center justify-between text-[13px]">
              ...
              <div className="flex items-center gap-1">
                ...
                <button className="w-7 h-7 flex items-center justify-center rounded-lg bg-blue-600 text-white font-medium shadow-sm">1</button>
                <button className="w-7 h-7 flex items-center justify-center rounded-lg hover:bg-gray-100 text-gray-600 font-medium transition-colors">2</button>
                <button className="w-7 h-7 flex items-center justify-center rounded-lg hover:bg-gray-100 text-gray-600 font-medium transition-colors">3</button>
                <span className="text-gray-400 mx-1">...</span>
                <button className="w-7 h-7 flex items-center justify-center rounded-lg hover:bg-gray-100 text-gray-600 font-medium transition-colors">15</button>
