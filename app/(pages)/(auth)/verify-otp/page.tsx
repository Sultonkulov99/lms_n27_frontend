                ...
                <div className="w-full max-w-md mx-auto my-auto py-8 text-center">
                    ...
                    >
                        ...
                        <div className="flex flex-col items-center gap-2 py-1">
                            ...
                            <span>
                                Tasdiqlash kodi kiritilgan telefon raqamining telegram akkaunti orqali telegram bot: <a href="https://t.me/lms_n27_bot" className="text-[#3B82F6]">@lms_n27_bot</a>  dan tasdiqlash kodini oling!
                            </span>
                        </div>
