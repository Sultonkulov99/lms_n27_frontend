...
export default function Mentors() {
  // Default hovered mentor set to Istamov Xurshid (index 2) as seen in screenshot
  ...
  return (
    <section id="mentors" className="py-16 lg:py-20 bg-white overflow-hidden">
      ...
      {/* Full width horizontal carousel / strip spanning screen width */}
          ...
          {mentors.map((m) => {
            ...
            return (
              ...
              >
                ...
                {/* Dark Gradient Overlay & Data (Shown on hover or when active) */}
                <div
                  className={`absolute inset-0 bg-gradient-to-t from-black/80 via-black/30 to-transparent flex flex-col justify-end p-6 transition-opacity duration-300 ${
                ...
                >
                  ...
                  <div className="flex items-center gap-3 text-white/80">
                    {m.socials.telegram && (
                      <a href={m.socials.telegram} className="hover:text-white transition-colors">
                    ...
                    {m.socials.instagram && (
                      <a href={m.socials.instagram} className="hover:text-white transition-colors">
                        <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
                    ...
                    {m.socials.facebook && (
                      <a href={m.socials.facebook} className="hover:text-white transition-colors">
                        <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
